...
class indentdataexcelextract(models.Model):
    branch =  models.CharField(max_length=255, null=True, blank=True)    
    ...
    custName = models.CharField(max_length=255, null=True, blank=True)
    WM10L = models.FloatField(default=0.00,null=True, blank=True)
    WM20L = models.FloatField(default=0.00,null=True, blank=True)
    WM40L = models.FloatField(default=0.00,null=True, blank=True)
    WMSPL = models.FloatField(default=0.00,null=True, blank=True)
    SKM = models.FloatField(default=0.00,null=True, blank=True)
    TM = models.FloatField(default=0.00,null=True, blank=True)
    RCM = models.FloatField(default=0.00,null=True, blank=True)
    CURD10KB = models.FloatField(default=0.00,null=True, blank=True)
    CURD20KB = models.FloatField(default=0.00,null=True, blank=True)
    CURD40KB = models.FloatField(default=0.00,null=True, blank=True)
    CURD5KB = models.FloatField(default=0.00,null=True, blank=True)
    CURD1KB = models.FloatField(default=0.00,null=True, blank=True)
    TOTINDENT = models.FloatField(default=0.00,null=True, blank=True)
    INDENTAMT = models.FloatField(default=0.00,null=True, blank=True)
    RECAMT = models.FloatField(default=0.00,null=True, blank=True)
    BALAMT = models.FloatField(default=0.00,null=True, blank=True)
    RECDATE = models.DateField(null=True,blank=True)
    recType = models.CharField(max_length=25,null=True,blank=True)
    RecRemarks = models.CharField(max_length=50,null=True,blank=True)
    Remarks =  models.CharField(max_length=50,null=True,blank=True) 
    sourcedata = models.CharField(max_length=50,null=True,blank=True)       
...
## Report Daily Sales
# rpt_daily_sales branch,custcode,custName,date,shift,orderNo,custType,prodCode,prodName,quantity,couponCode,disc,comm,amount,unitRate,netAmount,ZoneCode,ZoneName,SaleExecCode,SaleExecName,remarks,did1,oid1,cid1,pid1,zid1,sid1
class rpt_daily_sales(models.Model):
    branch =  models.CharField(max_length=255, null=True, blank=True)    
    custcode = models.CharField(max_length=255, null=True, blank=True)#Customer.custCode-custName
    custName = models.CharField(max_length=255, null=True, blank=True)
    date = models.DateField(null=True,blank=True)
    ...
    prodName  = models.CharField(max_length=25,null=True,blank=True)
    ...
    ZoneName =  models.CharField(max_length=255, null=True, blank=True)
    SaleExecCode =  models.CharField(max_length=255, null=True, blank=True)#SalesExec.SEcode
    SaleExecName =  models.CharField(max_length=255, null=True, blank=True)#SalesExec.SEcode
    remarks = models.CharField(max_length=25,null=True,blank=True)#key-in/Cash
    did1 = models.IntegerField(default=0) #dateWise
    oid1 = models.IntegerField(default=0) # orderWise 
    cid1 =  models.IntegerField(default=0) # custWise
    pid1 =  models.IntegerField(default=0) # productWise
    zid1 =  models.IntegerField(default=0) # zoneWise
    sid1 =  models.IntegerField(default=0) # salesExecWise
    #recAmount  = models.FloatField(default=0.00,null=True, blank=True)
    recDate = models.DateField(null=True,blank=True)
    osAmount  = models.FloatField(default=0.00,null=True, blank=True)
    recRefNo = models.CharField(max_length=25,null=True,blank=True)
...
## Report Daily Sales
# rpt_daily_sales branch,custcode,custName,date,shift,orderNo,custType,prodCode,prodName,quantity,couponCode,disc,comm,amount,unitRate,netAmount,ZoneCode,ZoneName,SaleExecCode,SaleExecName,remarks,did1,oid1,cid1,pid1,zid1,sid1
class rpt_daily_sales_subTot(models.Model):
    branch =  models.CharField(max_length=255, null=True, blank=True)    
    custcode = models.CharField(max_length=255, null=True, blank=True)#Customer.custCode-custName
    custName = models.CharField(max_length=255, null=True, blank=True)
    date = models.DateField(null=True,blank=True)
    ...
    prodCode  = models.CharField(max_length=25,null=True,blank=True)#prodMaster.PCode-PName
    prodName  = models.CharField(max_length=25,null=True,blank=True)
    qtyS = models.FloatField(default=0.00,null=True, blank=True)#float Keyin
    couponCode  = models.CharField(max_length=25,null=True,blank=True)#Coupon.cpCode-cpName
    discS = models.FloatField(default=0.00,null=True, blank=True)    
    commS  = models.FloatField(default=0.00,null=True, blank=True)    
    amountS  = models.FloatField(default=0.00,null=True, blank=True)
    unitRate  = models.FloatField(default=0.00,null=True, blank=True)#prodMaster.UnitRate   
    netAmountS  = models.FloatField(default=0.00,null=True, blank=True)#QTY*unitRate by ProdMaster.PCode 
    ZoneCode =  models.CharField(max_length=255, null=True, blank=True)#Zone.zCode-zName
    ZoneName =  models.CharField(max_length=255, null=True, blank=True)
    SaleExecCode =  models.CharField(max_length=255, null=True, blank=True)#SalesExec.SEcode
    SaleExecName =  models.CharField(max_length=255, null=True, blank=True)#SalesExec.SEcode
...
class indent(models.Model):
    ...
    amount  = models.FloatField(default=0.00,null=True, blank=True)
    netAmount  = models.FloatField(default=0.00,null=True, blank=True)#QTY*unitRate by ProdMaster.PCode 
    remove = models.CharField(max_length=3,null=True,blank=True,default='FI',)
    remarks = models.CharField(max_length=25,null=True,blank=True)#key-in/Cash
    upt_by = models.ForeignKey(User, on_delete=models.DO_NOTHING, blank=True, null=True, related_name='updIndent')
    created_by = models.ForeignKey(User, on_delete=models.DO_NOTHING, blank=True, null=True, related_name='createIndent')
    updatedd = models.DateTimeField(default=timezone.now)
    crreatedd = models.DateTimeField(default=timezone.now)
    recptNo =  models.IntegerField(default=0,null=True, blank=True)
    recDate = models.DateField(null=True,blank=True)
    RecAmount  = models.FloatField(default=0.00,null=True, blank=True)
    recRefNo = models.CharField(max_length=25,null=True,blank=True)
    OSAmount = models.FloatField(default=0.00,null=True, blank=True)
    WAmount = models.FloatField(default=0.00,null=True, blank=True)
    MILK10L =  models.FloatField(default=0.00,null=True, blank=True)
    MILK20L =  models.FloatField(default=0.00,null=True, blank=True)
    MILK40L =  models.FloatField(default=0.00,null=True, blank=True)
    MILK1L = models.FloatField(default=0.00,null=True, blank=True)
    GHEE1KG =  models.FloatField(default=0.00,null=True, blank=True)
    CURD10KGB = models.FloatField(default=0.00,null=True, blank=True)
    CURD20KGB = models.FloatField(default=0.00,null=True, blank=True)
    CURD40KGB = models.FloatField(default=0.00,null=True, blank=True)
    CURD5KGB = models.FloatField(default=0.00,null=True, blank=True)
    CURD1KGB = models.FloatField(default=0.00,null=True, blank=True)
    KOVA1KG =  models.FloatField(default=0.00,null=True, blank=True)
    KOVA5KG =  models.FloatField(default=0.00,null=True, blank=True)
    PANEER1KG = models.FloatField(default=0.00,null=True, blank=True)
    GHEE500GMS = models.FloatField(default=0.00,null=True, blank=True)
    GHEE250GMS = models.FloatField(default=0.00,null=True, blank=True)
    PANEER500GMS = models.FloatField(default=0.00,null=True, blank=True)
    CURD10KGCAN =  models.FloatField(default=0.00,null=True, blank=True)
    CURD20KGCAN = models.FloatField(default=0.00,null=True, blank=True)
    CURDDTM10KGCAN = models.FloatField(default=0.00,null=True, blank=True)
    CURDDTM10KGB = models.FloatField(default=0.00,null=True, blank=True)
    HIGHFATMILK = models.FloatField(default=0.00,null=True, blank=True)
    CURD5KGPOT = models.FloatField(default=0.00,null=True, blank=True)
    CURDTM10KGB = models.FloatField(default=0.00,null=True, blank=True)
    curdqty = models.FloatField(default=0.00,null=True, blank=True)
    milkqty = models.FloatField(default=0.00,null=True, blank=True)
    gheeqty = models.FloatField(default=0.00,null=True, blank=True)
    paneerqty = models.FloatField(default=0.00,null=True, blank=True)
    kovaqty = models.FloatField(default=0.00,null=True, blank=True)
    hfmqty = models.FloatField(default=0.00,null=True, blank=True)
    fsmqty = models.FloatField(default=0.00,null=True, blank=True)
    othqty = models.FloatField(default=0.00,null=True, blank=True)    
...
class saleorder(models.Model):
    ...
    remove = models.CharField(max_length=3,null=True,blank=True,default='FI',)
    remarks = models.CharField(max_length=25,null=True,blank=True)#key-in/Cash
    upt_by = models.ForeignKey(User, on_delete=models.DO_NOTHING, blank=True, null=True, related_name='updSaleOrder')
    created_by = models.ForeignKey(User, on_delete=models.DO_NOTHING, blank=True, null=True, related_name='createSaleOrder')
    updatedd = models.DateTimeField(default=timezone.now)
    crreatedd = models.DateTimeField(default=timezone.now)
    recptNo =  models.IntegerField(default=0,null=True, blank=True)
    recDate = models.DateField(null=True,blank=True)
...
#school_daily_sales - custcode,date,shift,orderNo,custType,prodCode,quantity,couponCode,disc,comm,amount,unitRate,netAmount,ZoneCode,SaleExecCode,remarks
class daily_sales(models.Model):
    ...
    updUser = models.CharField(max_length=50, null=True, blank=True)
    #RecAmount  = models.FloatField(default=0.00,null=True, blank=True)
    recRefNo = models.CharField(max_length=25,null=True,blank=True)
    customerName = models.CharField(max_length=255, null=True, blank=True)
    qtyinUnits = models.FloatField(default=0.00,null=True, blank=True)
    RAmt = models.FloatField(default=0.00,null=True, blank=True)        
    WAmt = models.FloatField(default=0.00,null=True, blank=True)
    OSAMT = models.FloatField(default=0.00,null=True, blank=True)
    PAmt = models.FloatField(default=0.00,null=True, blank=True)    
    ...
    def __str__(self):
        return self. custcode
#prodMaster-PCode,PName,document,custType,PStDate,PEndDate,unitRate,prod_type,qty_from,qty_to,active,remove,sourcedata
class prodMaster(models.Model):
    ...
    custType = models.CharField(max_length=255,null=True,blank=True)
    ...
    remove = models.CharField(max_length=255,null=True,blank=True)
    sourcedata = models.CharField(max_length=50,null=True,blank=True)                          
    prodLabel = models.CharField(max_length=255,null=True,blank=True)
    milkUnits = models.FloatField(default=0.0,null=True,blank=True)
    splCustCode = models.CharField(max_length=100,null=True,blank=True)
    cont = models.CharField(max_length=3,null=True,blank=True,default='Pac')
    UOM = models.CharField(max_length=5,null=True,blank=True,default='KG')
    HSN = models.CharField(max_length=15,null=True,blank=True,default='-')
    prodQ = models.CharField(max_length=25, null=True, blank=True)
    qtyL = models.CharField(max_length=25, null=True, blank=True)
...
class equip_receipts(models.Model):
    branch =  models.CharField(max_length=255, null=True, blank=True)    
    ...
    eqRecdate = models.DateField(null=True,blank=True)
    eqType = models.CharField(max_length=15, null=True, blank=True)#CASH/CHEQUE/I-BANK
    eqRefNo  = models.CharField(max_length=25,null=True,blank=True)#key-in/Cash/Chqno/internetbankingrefcode    
    eqUnits  = models.FloatField(default=0.00,null=True, blank=True)    
    remarks = models.CharField(max_length=25,null=True,blank=True)#key-in/Cash
    remove = models.CharField(max_length=255,null=True,blank=True)
...
class Customer(models.Model):
    ...
    remove = models.CharField(max_length=255,null=True,blank=True)
    sourcedata = models.CharField(max_length=50,null=True,blank=True)
    custserial = models.IntegerField(default=0,null=True,blank=True)
...
class prodType(models.Model):
    ...
    remove = models.CharField(max_length=255,null=True,blank=True)
    pTypeLabel = models.CharField(max_length=255,null=True,blank=True)

    def __str__(self):
        return self.pTypeCode
