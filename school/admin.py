...
#@admin.register(prodMaster)
#class prodMasterAdmin(ImportExportModelAdmin):
#    list_display = ('PCode','PName','custType','PStDate','PEndDate','unitRate','prod_type','qty_from','qty_to','active','sourcedata')
#    print('@45-admin.py')
@admin.register(prodMaster)
class prodMasterAdmin(ImportExportModelAdmin):
    list_display = ('PCode','PName','document','custType','PStDate','PEndDate','unitRate','prod_type','qty_from','qty_to','active','remove','sourcedata')
    #list_display = ('PCode','PName','active')
    #print('@45-admin.py',list_display)
...
class custMasterAdmin(ImportExportModelAdmin):
    list_display = ('branch','custCode','custName','cust_type','zoneCode','saleExecCode','mobile','email','address','document','distance','active','remove','sourcedata')

#indentdataexcelextract # branch,Saledate,custcode,custName,WM10L,WM20L,WM40L,WMSPL,SKM,TM,RCM,CURD10KB,CURD20KB,CURD40KB,CURD5KB,CURD1KB,TOTINDENT,INDENTAMT,RECAMT,BALAMT,RECDATE,recType,RecRemarks,Remarks,sourcedata
@admin.register(indentdataexcelextract)
class indentdataexcelextractAdmin(ImportExportModelAdmin):
    list_display = ('branch','Saledate','custcode','custName','WM10L','WM20L','WM40L','WMSPL','SKM','TM','RCM','CURD10KB','CURD20KB','CURD40KB','CURD5KB','CURD1KB','TOTINDENT','INDENTAMT','RECAMT','BALAMT','RECDATE','recType','RecRemarks','Remarks','sourcedata')
