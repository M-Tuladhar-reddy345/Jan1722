...
from school.models import indentdataexcelextract,Excelupload,prodMaster,Customer,dailydataExcelupload,PayDetailsExcelupload,tsratesexcelupload,Centermasterdataexcelupload,Ifscexcelupload,ExtractEMSData,ExtractPlantData,Proc_Data_EE
...
class prodMasterReource(resources.ModelResource):
    class meta: 
        model = prodMaster
        
class CustomerReource(resources.ModelResource):
    class meta: 
        model = Customer
        
class indentdataexcelextractReource(resources.ModelResource):
    class meta: 
        model = indentdataexcelextract
